            ...
            <ul class="nav navbar-nav">
				...
				<li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="freqborrowerb.php">Frequent borrowers in a branch</a></li>
...
<form action="freqborrowedbookb.php" method="post">
<table>
<tr>
<td></td>
...
$result = mysqli_query($con," select * from book where libid='$libid' order by borrowcount desc");
