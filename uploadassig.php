...
<body>
		...
		<div class="col-xs-4" style="background-color:white ">
			...
			<table class="table table-hover"  width="100%" >
				...
				<tr>
					...
					<th colspan="3" > <h2 align="center"> Enter Assignment Details </h2> </th>
				</tr>
				...
				<tr>
					<td> <input type="number" name="isbn" class="form-control" placeholder="Subject Name" required/> </td>
				...
				<tr>
					...
					<tr><td><input type="text" name="update" class="form-control" placeholder="Upload Date" id="txtdatepicker" required/></td>
					
					<tr><td><input type="text" name="duedate" class="form-control" placeholder="Due Date" id="txtdatepicker" required/></td>
   ...
   <body style="background:url(http://www.psdgraphics.com/file/silver-database-icon.jpg)"></body>
</body>
